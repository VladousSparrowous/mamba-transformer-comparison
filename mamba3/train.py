...
import wandb
import os
from mamba3 import Mamba3LMHeadModel, Mamba3Config
import gc
    ...
    def finetune(self, train_loader, val_loader, test_loader=None):
        ...
        for epoch in range(self.config.num_epochs):
            ...
            if val_acc > best_val_acc:
                ...
                patience_counter = 0
                torch.save(self.model.state_dict(), "best_model_mamba3.pt")
            else:
                patience_counter += 1
        ...
        if os.path.exists("best_model_mamba3.pt"):
            self.model.load_state_dict(torch.load("best_model_mamba3.pt"))
